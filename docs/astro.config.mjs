    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          label: 'Cogitator',
          collapsed: false,
          items: [{ autogenerate: { directory: 'cogitator' } }],
        },
        {
          label: 'Forge',
          translations: { fr: 'La Forge' },
          collapsed: false,
          items: [{ autogenerate: { directory: 'forge' } }],
        },
        {
          label: 'Schematics',
          translations: { fr: 'Schémas' },
          collapsed: true,
          items: [{ autogenerate: { directory: 'schematics', collapsed: true } }],
        },
        {
          label: 'Provings',
          translations: { fr: 'Épreuves' },
          collapsed: true,
          items: [{ autogenerate: { directory: 'provings', collapsed: true } }],
        },
        {
          label: 'Reference',
